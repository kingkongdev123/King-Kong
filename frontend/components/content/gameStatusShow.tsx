  ...
  return (
    <>
              ...
              props.round == 0 ?
                ...
                (props.round == 1 || props.round > 1 && pfpArray.length == 16 && round1result.length == 8 && round2result.length == 4 && round2result[0] == round1result[0]) ?
                  ...
                  <>
                    ...
                    <span className={`${styles.crossIconR2} ${styles.r2PlayerL1}`}>
                      <span className={styles.crossIcon}>
                        <CrossIcon />
                      </span>
                    </span>
      ...
      <div className={styles.mdContainer}>
        ...
        {/* round 1 panels */}
        <div className={`${styles.roundPanel} ${styles.dJustifyContentBetween}`}>
          <div className={`${styles.mdLeftPanel} ${styles.dColumnJustifyContentBetween}`}>
            <div className={styles.dJustifyContentBetween}>
              <div className={styles.round1pair}>
                {
                  props.round == 0 && pfpArray.length < 1 ?
                    // false ?
                    <span className={styles.mdRound1Avatar}>
                      <img src='/img/avatar.png' alt='empty' className={styles.r1avatar} />
                    </span> :
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 1 && round1result.length > 0 && round1result[0] == 0) ?
                        // false ?
                        <img
                          ...
                          // '/img/avatar.png'
                          alt='avatar'
                          className={`${styles.mdRoundImgBorder} ${styles.mdRound1Avatar}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img
                            src={pfpArray[0]}
                            // 'https://img-cdn.magiceden.dev/rs:fill:400:400:0:0/plain/https://arweave.net/MGZ8pu37zWqjYIfIYWqH8fWMNxZsF_x8CYoDX0TjKow'
                            alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                          </span>
                        </div>
                    )
                }
                {
                  props.round == 0 && pfpArray.length < 2 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 2 && round1result.length > 0 && round1result[0] == 1) ?
                        <img src={pfpArray[1]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[1]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                ...
                <span className={styles.r1vsLabelWrapper}>
                  <span className={styles.r1vsLabel}>
                    vs
                  </span>
                </span>
              </div>
              <div className={styles.round1pair}>
                {
                  props.round == 0 && pfpArray.length < 3 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 3 && round1result.length > 1 && round1result[1] == 2) ?
                        <img src={pfpArray[2]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[2]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                ...
                }
                {
                  props.round == 0 && pfpArray.length < 4 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 4 && round1result.length > 1 && round1result[1] == 3) ?
                        <img src={pfpArray[3]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[3]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
              ...
              <div className={styles.round1pair}>
                {
                  props.round == 0 && pfpArray.length < 5 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 5 && round1result.length > 2 && round1result[2] == 4) ?
                        <img src={pfpArray[4]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[4]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                ...
                }
                {
                  props.round == 0 && pfpArray.length < 6 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 6 && round1result.length > 2 && round1result[2] == 5) ?
                        <img src={pfpArray[5]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[5]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
              ...
              <div className={styles.round1pair}>
                {
                  props.round == 0 && pfpArray.length < 7 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 7 && round1result.length > 3 && round1result[3] == 6) ?
                        <img src={pfpArray[6]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[6]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                ...
                }
                {
                  props.round == 0 && pfpArray.length < 8 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 8 && round1result.length > 3 && round1result[3] == 7) ?
                        <img src={pfpArray[7]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[7]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
          ...
          <div className={`${styles.mdRightPanel} ${styles.dColumnJustifyContentBetween}`}>
            <div className={styles.dJustifyContentBetween}>
              <div className={styles.round1pair}>
                {
                  props.round == 0 && pfpArray.length < 9 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 9 && round1result.length > 4 && round1result[4] == 8) ?
                        <img src={pfpArray[8]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[8]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                ...
                }
                {
                  props.round == 0 && pfpArray.length < 10 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 10 && round1result.length > 4 && round1result[4] == 9) ?
                        <img src={pfpArray[9]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[9]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
              ...
              <div className={styles.round1pair}>
                {
                  props.round == 0 && pfpArray.length < 11 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 11 && round1result.length > 5 && round1result[5] == 10) ?
                        <img src={pfpArray[10]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[10]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
...

                {
                  props.round == 0 && pfpArray.length < 12 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 12 && round1result.length > 5 && round1result[5] == 11) ?
                        <img src={pfpArray[11]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[11]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
              ...
              <div className={styles.round1pair}>
                {
                  props.round == 0 && pfpArray.length < 13 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 13 && round1result.length > 6 && round1result[6] == 12) ?
                        <img src={pfpArray[12]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[12]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                ...
                }
                {
                  props.round == 0 && pfpArray.length < 14 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 14 && round1result.length > 6 && round1result[6] == 13) ?
                        <img src={pfpArray[13]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[13]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
              ...
              <div className={styles.round1pair}>
                {
                  props.round == 0 && pfpArray.length < 15 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 15 && round1result.length > 7 && round1result[7] == 14) ?
                        <img src={pfpArray[14]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[14]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                ...
                }
                {
                  props.round == 0 && pfpArray.length < 16 ?
                    ...
                    (
                      (props.round == 0 || props.round > 0 && pfpArray.length >= 16 && round1result.length > 7 && round1result[7] == 15) ?
                        <img src={pfpArray[15]} alt='avatar' className={`${styles.mdRound1Avatar} ${styles.mdRoundImgBorder}`} /> :
                        <div className={styles.mdRound1Avatar}>
                          <img src={pfpArray[15]} alt='avatar' className={styles.r1UnrealAvatar} />
                          <span className={styles.crossIcon}>
                            <CrossIcon />
          ...
          <img src='/img/GrandPrize.png' alt='prize' />
        </div>

        {/* text panel */}
        {
          (countdownShow || props.round == 0 && !countdownShow && forceWaitingShow) &&
          <div className={styles.showingTextPanel}>
            <span className={styles.roundShowPanel}>

              {
                props.round == 0 && !countdownShow && forceWaitingShow &&
                <span className={styles.enteredPlayersText}>
                  {pfpArray.length} &nbsp;/&nbsp;16
                </span>
              }
              {
            ...
            <span className={`${styles.textShowPanel} ${countdownShow && styles.flexColumn}`}>
              {
                props.round == 0 && !countdownShow && forceWaitingShow &&
                <span className={styles.waitingPlayersText}>
                  WAITING FOR MORE PLAYERS
                </span>
              }
              {
                countdownShow &&
                <>
                  <span className={`${styles.startingRoundText} `}>
                    STARTING ROUND {props.round + 1}
                  </span>
                  <span className={styles.onlinePlayersText}>
                    {32 / Math.pow(2, props.round + 1)} Players Online
                  </span>
                </>
              }
        ...
        {/* round2 panels */}
        <div className={`${styles.roundPanel} ${styles.dJustifyContentBetween}`}>
          <div className={`${styles.mdLeftPanel} ${styles.dColumnJustifyContentEvenly}`}>
            <div className={styles.dJustifyContentCenter}>
              <div className={styles.round1pair}>
                {
                  props.round == 0 ?
                    <span className={styles.mdRound2Avatar}>
                      <span className={styles.mdR2LockIcon}>
                        <LockIcon />
                      </span>
                    </span> :
                    (props.round == 1 || props.round > 1 && pfpArray.length == 16 && round1result.length == 8 && round2result.length == 4 && round2result[0] == round1result[0]) ?
                      <img
                        src={pfpArray[round1result[0]]}
                        alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img
                          src={pfpArray[(round1result[0] as number)]}
                          alt='avatar' className={`${styles.mdRound2Avatar}`} />
                        <span className={`${styles.mdRound2Avatar} ${styles.crossIconR2}`}>
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                          </span>
                        </span>
                ...
                }
                {
                  props.round == 0 ?
                    ...
                    (props.round == 1 || props.round > 1 && pfpArray.length == 16 && round1result.length == 8 && round2result.length == 4 && round2result[0] == round1result[1]) ?
                      <img src={pfpArray[round1result[1]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round1result[1] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />

                        <span className={`${styles.crossIconR2} ${styles.mdRound2Avatar}`}>
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                          </span>
                        </span>
                ...
                <span className={styles.r2vsLabelWrapper}>
                  <span className={styles.r2vsLabel}>
                    vs
                  </span>
                </span>
              </div>
              ...
              <div className={styles.round1pair}>
                {
                  props.round == 0 ?
                    ...
                    (props.round == 1 || props.round > 1 && pfpArray.length == 16 && round1result.length == 8 && round2result.length == 4 && round2result[1] == round1result[2]) ?
                      <img src={pfpArray[round1result[2]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :

                      <>
                        <img src={pfpArray[(round1result[2] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
                ...
                }
                {
                  props.round == 0 ?
                    ...
                    (props.round == 1 || props.round > 1 && pfpArray.length == 16 && round1result.length == 8 && round2result.length == 4 && round2result[1] == round1result[3]) ?
                      <img src={pfpArray[round1result[3]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round1result[3] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
          ...
          <div className={`${styles.mdRightPanel} ${styles.dColumnJustifyContentEvenly}`}>
            <div className={styles.dJustifyContentCenter}>
              <div className={styles.round1pair}>
                {
                  props.round == 0 ?
                    ...
                    (props.round == 1 || props.round > 1 && pfpArray.length == 16 && round1result.length == 8 && round2result.length == 4 && round2result[2] == round1result[4]) ?
                      <img src={pfpArray[round1result[4]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round1result[4] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
...

                {
                  props.round == 0 ?
                    ...
                    (props.round == 1 || props.round > 1 && pfpArray.length == 16 && round1result.length == 8 && round2result.length == 4 && round2result[2] == round1result[5]) ?
                      <img src={pfpArray[round1result[5]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round1result[5] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
              ...
              <div className={styles.round1pair}>
                {
                  props.round == 0 ?
                    ...
                    (props.round == 1 || props.round > 1 && pfpArray.length == 16 && round1result.length == 8 && round2result.length == 4 && round2result[3] == round1result[6]) ?
                      <img src={pfpArray[round1result[6]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round1result[6] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
                ...
                }
                {
                  props.round == 0 ?
                    ...
                    (props.round == 1 || props.round > 1 && pfpArray.length == 16 && round1result.length == 8 && round2result.length == 4 && round2result[3] == round1result[7]) ?
                      <img src={pfpArray[round1result[7]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round1result[7] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
        ...
        {/* round3 panels */}
        <div className={`${styles.roundPanel} ${styles.dJustifyContentBetween}`}>
          <div className={`${styles.mdLeftPanel} ${styles.dJustifyContentCenter}`}>
            <div className={styles.dJustifyContentCenter}>
              <div className={styles.round1pair}>
                {
                  props.round < 2 ?
                    ...
                    (props.round == 2 || props.round > 2 && pfpArray.length == 16 && round2result.length == 4 && round3result.length == 2 && round3result[0] == round2result[0]) ?
                      <img src={pfpArray[round2result[0]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round2result[0] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
                ...
                }
                {
                  props.round < 2 ?
                    ...
                    (props.round == 2 || props.round > 2 && pfpArray.length == 16 && round2result.length == 4 && round3result.length == 2 && round3result[0] == round2result[1]) ?
                      <img src={pfpArray[round2result[1]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round2result[1] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
                        <span className={`${styles.crossIconR2} ${styles.mdRound2Avatar}`}>
                          <span className={`${styles.crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                          </span>
          ...
          <div className={`${styles.mdRightPanel} ${styles.dJustifyContentCenter}`}>
            <div className={styles.dJustifyContentCenter}>
              <div className={styles.round1pair}>
                {
                  props.round < 2 ?
                    ...
                    (props.round == 2 || props.round > 2 && pfpArray.length == 16 && round2result.length == 4 && round3result.length == 2 && round3result[1] == round2result[2]) ?
                      <img src={pfpArray[round2result[2]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round2result[2] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
                        <span className={`${styles.crossIconR2} ${styles.mdRound2Avatar}`}>
                ...
                }
                {
                  props.round < 2 ?
                    ...
                    (props.round == 2 || props.round > 2 && pfpArray.length == 16 && round2result.length == 4 && round3result.length == 2 && round3result[1] == round2result[3]) ?
                      <img src={pfpArray[round2result[3]]} alt='avatar' className={`${styles.mdRound2Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round2result[3] as number)]} alt='avatar' className={`${styles.mdRound2Avatar}`} />
                        <span className={`${styles.crossIconR2} ${styles.mdRound2Avatar}`}>
        ...
        <div className={`${styles.roundPanel} ${styles.dJustifyContentBetween}`}>
          <div className={`${styles.mdLeftPanel} ${styles.dJustifyContentCenter}`}>
            <div className={styles.dJustifyContentCenter}>
              <div className={styles.round1pair}>
                {
                  props.round < 3 ?
                    <span className={styles.mdRound4Avatar}>
                      <span className={styles.mdR2LockIcon}>
                        <LockIcon />
                      </span>
                    </span> :
                    (props.round == 3 || props.round > 3 && pfpArray.length == 16 && round4result.length == 1 && round3result.length == 2 && round3result[0] == round4result[0]) ?
                      <img src={pfpArray[round3result[0]]} alt='avatar' className={`${styles.mdRound4Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round3result[0] as number)]} alt='avatar' className={`${styles.mdRound4Avatar}`} />

                        <span className={`${styles.crossIconR4} ${styles.mdRound4Avatar}`}>
                          <span className={`${styles.r4crossIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                          </span>
                        </span>
                      </>
              ...
              <div className={styles.round1pair}>
                {
                  props.round < 3 ?
                    ...
                    (props.round == 3 || props.round > 3 && pfpArray.length == 16 && round4result.length == 1 && round3result.length == 2 && round3result[1] == round4result[0]) ?
                      <img src={pfpArray[round3result[1]]} alt='avatar' className={`${styles.mdRound4Avatar}`} /> :
                      <>
                        <img src={pfpArray[(round3result[1] as number)]} alt='avatar' className={`${styles.mdRound4Avatar}`} />

                        <span className={`${styles.crossIconR4} ${styles.mdRound4Avatar}`}>
                          <span className={`${styles.r4LockIcon} ${styles.positionAbsolute}`}>
                            <CrossIcon />
                          </span>
                        </span>
                      </>
          ...
          <span className={styles.r4vsLabelWrapper}>
            <span className={styles.r4vsLabel}>
              vs
            </span>
          </span>
